...
drop index UTIC.FK_UZMTSYSTEM_ID_FK;
...
create table UTIC.UZMTNOTIFICATION_TYPE (
   ...
   UZMTNOTIFICATION_TYPE_USUA VARCHAR2(200),
...
comment on column UTIC.UZMTNOTIFICATION_TYPE.UZMTNOTIFICATION_TYPE_USUA is
...
/*==============================================================*/
/* Index: FK_UZMTSYSTEM_ID_FK                                   */
/*==============================================================*/
create index UTIC.FK_UZMTSYSTEM_ID_FK on UTIC.UZMTOPTION (
