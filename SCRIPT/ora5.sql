...
create table UTIC.UZMTGROUP (
   ...
   UZMTGROUP_PARAMETRO  NUMBER(1),
   UZMTGROUP_ACTIVE     NUMBER(1),
...
create table UTIC.UZMTNOTIFICATION (
   ...
   UZMTNOTIFICATION_ACTIVE NUMBER(1),
   UZMTNOTIFICATION_READ NUMBER(1),
...
create table UTIC.UZMTNOTIFICATION_TYPE (
   ...
   UZMTNOTIFICATION_TYPE_ACTIVE NUMBER(1),
